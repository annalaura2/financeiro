...
document.getElementById('filterButton').addEventListener('click', function() {
  ...
  function filtrarInformacoes() {
    ...
    var row = '<tr>';
    row += '<td>' + annaLaura.nomePagador + '</td>';
    row += '<td>' + annaLaura.identificacaoNota + '</td>';
    row += '<td>' + annaLaura.dataEmissaoNota + '</td>';
    row += '<td>' + annaLaura.dataCobranca + '</td>';
    row += '<td>' + annaLaura.dataPagamento + '</td>';
    row += '<td>' + annaLaura.valorNota + '</td>';
    row += '<td>' + annaLaura.docNotaFiscal + '</td>';
    row += '<td>' + annaLaura.docBoleto + '</td>';
    row += '<td>' + annaLaura.statusNota + '</td>';
    row += '</tr>';
